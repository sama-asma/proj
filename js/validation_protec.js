document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('formProtectionJuridique');
    let isValide = true;
    ...
    dateNaissanceInput.addEventListener('blur', function() {
        ...
        if (age < 18 || age > 90) {
            showError(this, 'Le client doit avoir entre 18 et 90 ans');
        } else {
            clearError(this);
        }
    });
    ...
    document.getElementById('formProtectionJuridique').addEventListener('keydown', function(e) {
        if (e.key === 'Enter') {
    ...
    document.getElementById('formProtectionJuridique').addEventListener('submit', function(e) {
    ...
    btnRecherche.addEventListener('click', function() {
        ...
        listeClients.addEventListener('click', function(e) {
            if (e.target.classList.contains('select-btn')) {
                ...
                document.getElementById('situation_pro').focus();
            }
        });
